...
print ip_dst, ip_s1, ip_s2, controller_type, file_attackerList, file_path_pi
...
class nfv_controller(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        global firstICMP
        if pkt_icmp and firstICMP == True:
            self.logger.info("***** First ICMP Packet *****")
            ts = time.time()
        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if pkt_ipv4:
                if pkt_ipv4.dst == ip_dst and (pkt_ipv4.src == ip_s1 or pkt_ipv4.src == ip_s2):
                    ...
                    # if roundrobin controller, sent in RR fashion
